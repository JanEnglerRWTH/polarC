...
from transformers import AutoTokenizer, AutoModelForQuestionAnswering, BertModel, PreTrainedModel, AutoConfig, \
  BertPreTrainedModel, AutoModelForSequenceClassification, BertForTokenClassification,AutoModelForTokenClassification
...
def createPolarDimension(model, tokenizer, out_path, antonym_path=""):
  ...
  if antonym_path == "":
    dict_path = "/home/jengler/projects/contextualised_polar/antonyms/antonym_wordnet_example_sentences_readable_extended.txt"
  else:
...
if __name__ == "__main__":
  original_model="downstream_tasks/GLUE/models/mrpc/Baseline/"
  new_model_path="downstream_tasks/GLUE/models/mrpc/Polar/"
  import os
